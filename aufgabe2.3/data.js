...
(function (Aufgabe2_3_2) {
    ...
    let wheel1 = { color: "black", price: "19,95€" };
    ...
    Aufgabe2_3_2.wheelArray.push(wheel1);
    /*previousElement.appendChild(div);
    previousElement = div;*/
    let wheel2 = { color: "brown", price: "21,95€" };
    ...
    div2.style.left = "40%";
    div.style.position = "absolute";*/
    Aufgabe2_3_2.wheelArray.push(wheel2);
    let wheel3 = { color: "grey", price: "16,95€" };
    ...
    div3.style.left = "60%";
    div.style.position = "absolute";*/
    Aufgabe2_3_2.wheelArray.push(wheel3);
    let colors = ["black", "black", "brown", "grey"];
    for (let i = 0; i < 3; i++) {
